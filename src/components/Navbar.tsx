...
return (
  <>
    <nav className="fixed top-0 left-0 right-0 z-50 transition-all duration-500 bg-cream/95 backdrop-blur-sm border-b border-stone/20">
      <div className="max-w-7xl mx-auto px-6 md:px-16 h-16 md:h-20 flex items-center justify-between">
        ...
        >
          <span className="font-body text-xl md:text-2xl tracking-wider text-dark group-hover:text-accent transition-colors duration-300">
            WUWA DESIGN STUDIO
          </span>
          <span className="text-[10px] md:text-xs tracking-wide text-dark/60">
            interior design company in Kuala Lumpur
          </span>
        </Link>
        ...
        >
          <span className={`block w-6 h-px bg-dark transition-all duration-300 ${menuOpen ? 'rotate-45 translate-y-2.5' : ''}`} />
